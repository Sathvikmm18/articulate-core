  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border/30 bg-card/50 backdrop-blur-md hover:bg-card/70 hover:shadow-glass",
        secondary: "bg-gradient-secondary text-secondary-foreground hover:opacity-90 shadow-glow-secondary",
        ghost: "hover:bg-muted hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        glass: "glass-button hover-lift",
        hero: "bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-elevation text-base font-semibold px-8 py-4 h-auto",
        accent: "bg-gradient-to-r from-accent to-accent-glow text-accent-foreground hover:opacity-90 shadow-glow",
      },
      size: {
